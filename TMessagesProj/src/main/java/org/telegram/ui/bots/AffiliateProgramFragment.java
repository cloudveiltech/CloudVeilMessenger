...
//            .setMessage(AndroidUtilities.replaceTags(getString(R.string.AffiliateProgramStopText)))
    ...
    public void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        //CloudVeil Disable items.add(FeatureCell.Factory.as(R.drawable.menu_feature_premium, getString(R.string.BotAffiliateProgramFeature1Title), getString(R.string.BotAffiliateProgramFeature1)));
