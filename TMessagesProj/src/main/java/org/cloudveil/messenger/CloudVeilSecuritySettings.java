...
public class CloudVeilSecuritySettings {
    ...
    public static int getProfilePhotoLimit() {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences(CloudVeilSecuritySettings.class.getCanonicalName(), Activity.MODE_PRIVATE);
        int limit = preferences.getInt("profilePhotoLimit", CloudVeilSecuritySettings.PROFILE_PHOTO_NO_LIMIT);
    ...
    public static boolean getIsProfileVideoDisabled() {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences(CloudVeilSecuritySettings.class.getCanonicalName(),
                Activity.MODE_PRIVATE);
        boolean res = preferences.getBoolean("isProfileVideoDisabled", CloudVeilSecuritySettings.DEFAULT_IS_PROFILE_VIDEO_DISABLED);
    ...
    public static boolean getIsProfileVideoChangeDisabled() {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences(CloudVeilSecuritySettings.class.getCanonicalName(), Activity.MODE_PRIVATE);
        boolean res = preferences.getBoolean("isProfileVideoChangeDisabled", CloudVeilSecuritySettings.DEFAULT_IS_PROFILE_VIDEO_CHANGE_DISABLED);
    ...
    public static boolean getIsDisableStories() {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences(CloudVeilSecuritySettings.class.getCanonicalName(), Activity.MODE_PRIVATE);
        boolean res = preferences.getBoolean("isStoriesDisabled", CloudVeilSecuritySettings.DEFAULT_LOCK_DISABLE_STORIES);
        return res;
    }
}
